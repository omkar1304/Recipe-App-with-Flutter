import 'dart:convert';
import 'dart:io';
import 'package:appguyrecipe/models/recipe_model.dart';
import 'package:appguyrecipe/views/recipe_view.dart';
                        ...
                        InkWell(
                            onTap: () async {
                              if (textEditingController.text.isNotEmpty) {
                                ...
                                recipies = [];
                                String url =
                                    "https://api.edamam.com/search?q=${textEditingController.text}&app_id=0cd05ec2&app_key=23828980101abece1e2f113d5258b29e";
